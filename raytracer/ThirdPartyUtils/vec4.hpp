 ...
 *
 *	DESCRIPTION:
 *		Header only 3D vector class implementation.
 *		Based on vec4 taken from Ray Tracing in One Weekend.
 *
 *	CONTRIBUTORS:
...
namespace RTIW
{
	...
	// point3 is just an alias for vec4, but useful for geometric clarity in
	// the code.
	using point4 = vec4;
